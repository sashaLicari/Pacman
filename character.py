...
# ===================================================================================================
class Character:
    def __init__(self, game, v, grid_pt, grid_pt_next, name='anonymous', scale=1.0, scale_factor=1):
...
class Ghost(Character):
    ...
    def calc_next(self, li):
        ...
        print(
            f'{self.name} is turning {direction} at index {self.grid_pt.index} -- next index {self.grid_pt_next.index}')
